...
def rewrite_with_tone(message, tone):
    ...
    try:
        ...
        st.error("❌ An error occurred while rewriting the message.")
        st.code(str(e))
        return "⚠️ Rewrite failed. Please check your API key and internet connection."
